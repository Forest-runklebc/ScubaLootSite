...
<asp:Content runat="server" ID="BodyContent" ContentPlaceHolderID="MainContent">
    ...
    <asp:Button ID="UpdateExistingRaid" runat="server" Text="Update Existing Raid" onClientClick="return confirm('Really update existing raid?')" OnClick="UpdateExistingRaid_Click" />
    <br />
